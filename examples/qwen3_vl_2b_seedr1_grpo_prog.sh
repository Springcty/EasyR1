#!/bin/bash
#SBATCH --job-name=easyr1-grpo-prog
#SBATCH --error=logs/easyr1-grpo-prog-qwen3vl-2b-seedr1.%j.err
#SBATCH --output=logs/easyr1-grpo-prog-qwen3vl-2b-seedr1.%j.out
#SBATCH --gres=gpu:8
...
apptainer exec --nv --cleanenv \
  ...
  trainer.experiment_name=qwen3_vl_2b_prog_r1_val1
